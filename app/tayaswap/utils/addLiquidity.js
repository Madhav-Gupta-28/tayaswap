...
export const calculateCD = async (
  ...
  const cryptoDevTokenAmount = _addEtherAmountWei
    ...
    console.log("_addEtherAmountWei:", _addEtherAmountWei.toString());
console.log("cdTokenReserve:", cdTokenReserve.toString());
console.log("etherBalanceContract:", etherBalanceContract.toString());
